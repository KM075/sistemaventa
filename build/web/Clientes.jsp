<%-- 
    Document   : Clientes
    Created on : 23/11/2021, 02:02:30 PM
    Author     : diana
--%>
                ...
                <div class="card-body">
                    <form action="Controlador?menu=Cliente" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${cliente.getDir()}" name="txtDir" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Estado</label>
                            <input type="text" value="${cliente.getEs()}" name="txtEstado" class="form-control" required="">
                        </div>
