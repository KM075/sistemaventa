<%-- 
    ...
    Created on : 23/11/2021, 02:02:56 PM
    Author     : diana
--%>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" name="codigocliente" value="${cl.getDni()}" class="form-control" placeholder="Codigo" required="">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="stock" value="${producto.getStock()}" class="form-control" placeholder="Stocke" >
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex col-sm-6 ml-auto">
                            ...
                            <div class="d-flex col-sm-5 ">
                                <input type="text" name="fecha" value="${fechahoy}" class="form-control">
                            </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <c:forEach var="listar" items="${listarventa}">
                                    <tr>

                                        <td>${listar.getItem()}</td>
                                        <td>${listar.getIdproducto()}</td>
                                        <td>${listar.getDescripcionP()}</td>
                                        <td>${listar.getPrecio()}</td>
                                        <td>${listar.getCantidad()}</td>
                                        <td>${listar.getSubtotal()}</td>
                                        <td class="d-flex">
